...
static void draw_q1(t_surface *surface, t_vec2 *top, t_vec2 center, t_color color)
{
    t_vec2f	pos;
...
static void draw_q2(t_surface *surface, t_vec2 *top, t_vec2 center, t_color color)
{
    t_vec2f	pos;
...
static void draw_q3(t_surface *surface, t_vec2 *top, t_vec2 center, t_color color)
{
    t_vec2f	pos;
