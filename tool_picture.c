...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/29 21:23:32 by ibarabas          #+#    #+#             */
/*   Updated: 2019/10/29 21:23:32 by ibarabas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	draw_picture(t_guimp *guimp, t_vec2_pair pair, t_surface *dst)
{
	...
	dst_rect.bottomright = vec2f_to_vec2(find_canvas_coordinates(guimp, vec2_to_vec2f(guimp->libui->mouse.pos)));
